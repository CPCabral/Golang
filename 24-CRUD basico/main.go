...
func main() {
	...
	router.HandleFunc("/usuarios", servidor.CriarUsuario).Methods(http.MethodPost) // URI é igual ,mas metodo é diferente
	router.HandleFunc("/usuarios", servidor.BuscarUsuarios).Methods(http.MethodGet) // URI é igual ,mas metodo é diferente
